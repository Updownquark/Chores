...
<quick-app xmlns:app="Quick-App v0.1" app-file="chore-champ.qml">
	...
	<toolkit def="/org/observe/expresso/logging/expresso-logging.qtd" />
	...
	<interpretation>org.observe.expresso.logging.ExpressoLoggingV0_1</interpretation>
